-- Update Order Status Configuration to match the updated getDefaultTransitions service
...
-- WAITER ROLE CONFIGURATION (matching your updated getDefaultTransitions)
-- New: Can view, acknowledge, start preparing, or cancel
...
-- Acknowledged: Can view, start preparing, or cancel
...
-- InProgress: Can view, mark complete, or cancel
...
-- Complete: Can view as completed, go back to in progress, or deliver
...
-- Delivered: Can view as delivered, go back to in progress, or mark paid
...
-- Rejected: Can view as rejected, go back to in progress, or cancel
INSERT INTO "order_status_config" ("currentStatus", "targetStatus", "userRole", "label") VALUES ('Rejected', 'Rejected', 'waiter', 'Rejected');
INSERT INTO "order_status_config" ("currentStatus", "targetStatus", "userRole", "label") VALUES ('Rejected', 'InProgress', 'waiter', 'In Progress');
INSERT INTO "order_status_config" ("currentStatus", "targetStatus", "userRole", "label") VALUES ('Rejected', 'Cancelled', 'waiter', 'Cancelled');

-- ADMIN ROLE CONFIGURATION (Full Control - All statuses available from any status)
